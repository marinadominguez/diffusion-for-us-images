...
The original ultrasound image is included here for comparison to better illustrate the differences between the synthetic image generated by the original SDM (baseline), the image generated using our method, and the actual ultrasound image.
